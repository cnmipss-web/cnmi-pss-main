...
var args41297 = [];
var len__27064__auto___41303 = arguments.length;
var i__27065__auto___41304 = (0);
while(true){
if((i__27065__auto___41304 < len__27064__auto___41303)){
args41297.push((arguments[i__27065__auto___41304]));

var G__41305 = (i__27065__auto___41304 + (1));
i__27065__auto___41304 = G__41305;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox41300 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox41300 = (function (obj,header,style,tag,meta41301){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox41300.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41302,meta41301__$1){
var self__ = this;
var _41302__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox41300(self__.obj,self__.header,self__.style,self__.tag,meta41301__$1));
});

devtools.toolbox.t_devtools$toolbox41300.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41302){
var self__ = this;
var _41302__$1 = this;
return self__.meta41301;
});

devtools.toolbox.t_devtools$toolbox41300.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox41300.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox41300.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox41300.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox41300.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta41301","meta41301",762191761,null)], null);
});

devtools.toolbox.t_devtools$toolbox41300.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox41300.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox41300";

devtools.toolbox.t_devtools$toolbox41300.cljs$lang$ctorPrWriter = (function (this__26595__auto__,writer__26596__auto__,opt__26597__auto__){
return cljs.core._write.call(null,writer__26596__auto__,"devtools.toolbox/t_devtools$toolbox41300");
});

devtools.toolbox.__GT_t_devtools$toolbox41300 = (function devtools$toolbox$__GT_t_devtools$toolbox41300(obj__$1,header__$1,style__$1,tag__$1,meta41301){
return (new devtools.toolbox.t_devtools$toolbox41300(obj__$1,header__$1,style__$1,tag__$1,meta41301));
});

}

return (new devtools.toolbox.t_devtools$toolbox41300(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1500616868586