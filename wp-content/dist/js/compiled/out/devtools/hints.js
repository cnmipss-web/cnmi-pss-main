...
var reader = (function (){var or__36756__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__36756__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__36756__auto__)){
return or__36756__auto__;
} else {
return (128);
...
}catch (e51140){var _e = e51140;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___51143 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___51143)){
var seen_errors_51144 = temp__4655__auto___51143;
if(cljs.core.truth_(seen_errors_51144.has(self))){
} else {
seen_errors_51144.add(self);

var temp__4657__auto___51145 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___51145)){
var sense_51146 = temp__4657__auto___51145;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_51146)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1503550048486