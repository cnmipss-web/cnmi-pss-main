...
var len__37889__auto___50181 = arguments.length;
var i__37890__auto___50182 = (0);
while(true){
if((i__37890__auto___50182 < len__37889__auto___50181)){
args__37896__auto__.push((arguments[i__37890__auto___50182]));

var G__50183 = (i__37890__auto___50182 + (1));
i__37890__auto___50182 = G__50183;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__37897__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq50179){
var G__50180 = cljs.core.first.call(null,seq50179);
var seq50179__$1 = cljs.core.next.call(null,seq50179);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__50180,seq50179__$1);
});
...
return (p1__50184_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1502260269305