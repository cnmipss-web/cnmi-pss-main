...
var G__50618 = devtools.prefs.pref.call(null,v);
v = G__50618;
continue;
} else {
return v;
...
var and__36745__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__36745__auto__){
var and__36745__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__36757__auto__ = (function (){try{if(!((value == null))){
...
}catch (e50621){var e__48594__auto__ = e50621;
return false;
}})();
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
var or__36757__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e50625){var e__48594__auto__ = e50625;
return false;
}})();
...
}catch (e50627){var e__48594__auto__ = e50627;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__36745__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__36745__auto__)){
var and__36745__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__36745__auto____$1){
...
var and__36745__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__36745__auto__)){
...
var or__36757__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
var and__36745__auto__ = (function (){var or__36757__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
var vec__50629 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__50629,(0),null);
var name = cljs.core.nth.call(null,vec__50629,(1),null);
...
var and__36745__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__36745__auto__)){
...
var or__36757__auto__ = typeof value === 'string';
if(or__36757__auto__){
return or__36757__auto__;
} else {
var or__36757__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__50632_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__50632_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1503441683759