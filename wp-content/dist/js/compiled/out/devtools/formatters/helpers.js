...
var G__71106 = devtools.prefs.pref.call(null,v);
v = G__71106;
continue;
} else {
return v;
...
}catch (e71119){var e__47200__auto__ = e71119;
return false;
}})();
...
}catch (e71123){var e__47200__auto__ = e71123;
return false;
}})();
...
}catch (e71125){var e__47200__auto__ = e71125;
return false;
}}
}
});
...
var vec__71130 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__71130,(0),null);
var name = cljs.core.nth.call(null,vec__71130,(1),null);
...
return cljs.core.some.call(null,(function (p1__71133_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__71133_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1498707056219