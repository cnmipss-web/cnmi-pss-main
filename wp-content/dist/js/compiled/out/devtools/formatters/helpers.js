...
var G__39137 = devtools.prefs.pref.call(null,v);
v = G__39137;
continue;
} else {
return v;
...
}catch (e39150){var e__36643__auto__ = e39150;
return false;
}})();
...
}catch (e39154){var e__36643__auto__ = e39154;
return false;
}})();
...
}catch (e39156){var e__36643__auto__ = e39156;
return false;
}}
}
});
...
var vec__39161 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39161,(0),null);
var name = cljs.core.nth.call(null,vec__39161,(1),null);
...
return cljs.core.some.call(null,(function (p1__39164_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39164_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1498622393061