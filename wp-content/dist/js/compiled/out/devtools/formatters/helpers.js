...
var G__40012 = devtools.prefs.pref.call(null,v);
v = G__40012;
continue;
} else {
return v;
...
}catch (e40015){var e__38029__auto__ = e40015;
return false;
}})();
...
}catch (e40019){var e__38029__auto__ = e40019;
return false;
}})();
...
}catch (e40021){var e__38029__auto__ = e40021;
return false;
}}
}
});
...
var vec__40023 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40023,(0),null);
var name = cljs.core.nth.call(null,vec__40023,(1),null);
...
return cljs.core.some.call(null,(function (p1__40026_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40026_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1501628496956