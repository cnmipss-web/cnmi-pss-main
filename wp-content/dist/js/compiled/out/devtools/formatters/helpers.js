...
var G__40555 = devtools.prefs.pref.call(null,v);
v = G__40555;
continue;
} else {
return v;
...
var and__25977__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25977__auto__){
var and__25977__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25989__auto__ = (function (){try{if(!((value == null))){
...
}catch (e40568){var e__38061__auto__ = e40568;
return false;
}})();
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
var or__25989__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e40572){var e__38061__auto__ = e40572;
return false;
}})();
...
}catch (e40574){var e__38061__auto__ = e40574;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25977__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25977__auto__)){
var and__25977__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25977__auto____$1){
...
var and__25977__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25977__auto__)){
...
var or__25989__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
...
var and__25977__auto__ = (function (){var or__25989__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
...
var vec__40579 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40579,(0),null);
var name = cljs.core.nth.call(null,vec__40579,(1),null);
...
var and__25977__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25977__auto__)){
...
var or__25989__auto__ = typeof value === 'string';
if(or__25989__auto__){
return or__25989__auto__;
} else {
var or__25989__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__40582_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40582_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1499813252647