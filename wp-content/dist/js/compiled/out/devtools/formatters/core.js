...
var and__36745__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__36745__auto__){
var or__36757__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e51036){var e__48594__auto__ = e51036;
return false;
...
}catch (e51038){var e__48594__auto__ = e51038;
return false;
...
}catch (e51040){var e__48594__auto__ = e51040;
return false;
...
}catch (e51042){var e__48594__auto__ = e51042;
return false;
...
}catch (e51044){var e__48594__auto__ = e51044;
return false;
}})())){
...
}catch (e51046){var e__48594__auto__ = e51046;
return false;
}})())){
...
var _STAR_current_state_STAR_51048 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__36757__auto__ = config;
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_51048;
}});
});
...
return (function() { 
var G__51050__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e51049){var e = e51049;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__51050 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51051__i = 0, G__51051__a = new Array(arguments.length -  0);
while (G__51051__i < G__51051__a.length) {G__51051__a[G__51051__i] = arguments[G__51051__i + 0]; ++G__51051__i;}
  args = new cljs.core.IndexedSeq(G__51051__a,0,null);
} 
return G__51050__delegate.call(this,args);};
G__51050.cljs$lang$maxFixedArity = 0;
G__51050.cljs$lang$applyTo = (function (arglist__51052){
var args = cljs.core.seq(arglist__51052);
return G__51050__delegate(args);
});
...
var pre_handler = (function (){var or__36757__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
var post_handler = (function (){var or__36757__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1503441684334