...
var and__36751__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__36751__auto__){
var or__36763__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e50579){var e__48137__auto__ = e50579;
return false;
...
}catch (e50581){var e__48137__auto__ = e50581;
return false;
...
}catch (e50583){var e__48137__auto__ = e50583;
return false;
...
}catch (e50585){var e__48137__auto__ = e50585;
return false;
...
}catch (e50587){var e__48137__auto__ = e50587;
return false;
}})())){
...
}catch (e50589){var e__48137__auto__ = e50589;
return false;
}})())){
...
var _STAR_current_state_STAR_50591 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__36763__auto__ = config;
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50591;
}});
});
...
while (G__50594__i < G__50594__a.length) {G__50594__a[G__50594__i] = arguments[G__50594__i + 0]; ++G__50594__i;}
  args = new cljs.core.IndexedSeq(G__50594__a,0,null);
} 
return G__50593__delegate.call(this,args);};
G__50593.cljs$lang$maxFixedArity = 0;
G__50593.cljs$lang$applyTo = (function (arglist__50595){
var args = cljs.core.seq(arglist__50595);
return G__50593__delegate(args);
});
G__50593.cljs$core$IFn$_invoke$arity$variadic = G__50593__delegate;
return G__50593;
})()
;
});
...
var pre_handler = (function (){var or__36763__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
var post_handler = (function (){var or__36763__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1502260269848