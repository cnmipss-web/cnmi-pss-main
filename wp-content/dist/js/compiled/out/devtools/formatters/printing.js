...
var len__28179__auto___40050 = arguments.length;
var i__28180__auto___40051 = (0);
while(true){
if((i__28180__auto___40051 < len__28179__auto___40050)){
args__28186__auto__.push((arguments[i__28180__auto___40051]));

var G__40052 = (i__28180__auto___40051 + (1));
i__28180__auto___40051 = G__40052;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28187__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40047){
var G__40048 = cljs.core.first.call(null,seq40047);
var seq40047__$1 = cljs.core.next.call(null,seq40047);
var G__40049 = cljs.core.first.call(null,seq40047__$1);
var seq40047__$2 = cljs.core.next.call(null,seq40047__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40048,G__40049,seq40047__$2);
});
...
if(cljs.core.truth_((function (){var or__27054__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27665__auto__,writer__27666__auto__,opt__27667__auto__){
return cljs.core._write.call(null,writer__27666__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27042__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27042__auto__){
var or__27054__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27054__auto__)){
return or__27054__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40053_SHARP_){
return !((cljs.core.meta.call(null,p1__40053_SHARP_) == null));
})))){
...
if(cljs.core.truth_((function (){var or__27054__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40058){var e__37997__auto__ = e40058;
return false;
}})();
if(cljs.core.truth_(or__27054__auto__)){
return or__27054__auto__;
...
}catch (e40060){var e__37997__auto__ = e40060;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40062 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40063 = opts;
...
var markup_db = cljs.core.get.call(null,map__40063__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40062;
}});
...
;
var temp__4655__auto___40067 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40067)){
var managed_print_level_40068 = temp__4655__auto___40067;
var _STAR_print_level_STAR_40066_40069 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40068;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40066_40069,managed_print_level_40068,temp__4655__auto___40067,writer,opts,job_fn){
return (function (p1__40065_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40065_SHARP_,null);
});})(_STAR_print_level_STAR_40066_40069,managed_print_level_40068,temp__4655__auto___40067,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40066_40069;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1502330259852