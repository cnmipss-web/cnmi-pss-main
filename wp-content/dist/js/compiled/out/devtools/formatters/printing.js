...
var len__37894__auto___50656 = arguments.length;
var i__37895__auto___50657 = (0);
while(true){
if((i__37895__auto___50657 < len__37894__auto___50656)){
args__37901__auto__.push((arguments[i__37895__auto___50657]));

var G__50658 = (i__37895__auto___50657 + (1));
i__37895__auto___50657 = G__50658;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37902__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50653){
var G__50654 = cljs.core.first.call(null,seq50653);
var seq50653__$1 = cljs.core.next.call(null,seq50653);
var G__50655 = cljs.core.first.call(null,seq50653__$1);
var seq50653__$2 = cljs.core.next.call(null,seq50653__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50654,G__50655,seq50653__$2);
});
...
if(cljs.core.truth_((function (){var or__36769__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__37380__auto__,writer__37381__auto__,opt__37382__auto__){
return cljs.core._write.call(null,writer__37381__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__36757__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__36757__auto__){
var or__36769__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__36769__auto__)){
return or__36769__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50659_SHARP_){
return !((cljs.core.meta.call(null,p1__50659_SHARP_) == null));
})))){
...
var map__50660 = opts;
var map__50660__$1 = ((((!((map__50660 == null)))?((((map__50660.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50660.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50660):map__50660);
var markup_db = cljs.core.get.call(null,map__50660__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__36769__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50664){var e__48603__auto__ = e50664;
return false;
}})();
if(cljs.core.truth_(or__36769__auto__)){
return or__36769__auto__;
...
}catch (e50666){var e__48603__auto__ = e50666;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50668 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50669 = opts;
var map__50669__$1 = ((((!((map__50669 == null)))?((((map__50669.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50669.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50669):map__50669);
var markup_db = cljs.core.get.call(null,map__50669__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50668;
}});
...
;
var temp__4655__auto___50673 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___50673)){
var managed_print_level_50674 = temp__4655__auto___50673;
var _STAR_print_level_STAR_50672_50675 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50674;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50672_50675,managed_print_level_50674,temp__4655__auto___50673,writer,opts,job_fn){
return (function (p1__50671_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50671_SHARP_,null);
});})(_STAR_print_level_STAR_50672_50675,managed_print_level_50674,temp__4655__auto___50673,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50672_50675;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1502846517637