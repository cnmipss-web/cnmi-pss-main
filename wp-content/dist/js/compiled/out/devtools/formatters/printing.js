...
var len__37882__auto___50647 = arguments.length;
var i__37883__auto___50648 = (0);
while(true){
if((i__37883__auto___50648 < len__37882__auto___50647)){
args__37889__auto__.push((arguments[i__37883__auto___50648]));

var G__50649 = (i__37883__auto___50648 + (1));
i__37883__auto___50648 = G__50649;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37890__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50644){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50645,G__50646,seq50644__$2);
});
...
if(cljs.core.truth_((function (){var or__36757__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__37368__auto__,writer__37369__auto__,opt__37370__auto__){
return cljs.core._write.call(null,writer__37369__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__36745__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__36745__auto__){
var or__36757__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50650_SHARP_){
return !((cljs.core.meta.call(null,p1__50650_SHARP_) == null));
})))){
...
var map__50651 = opts;
var map__50651__$1 = ((((!((map__50651 == null)))?((((map__50651.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50651.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50651):map__50651);
var markup_db = cljs.core.get.call(null,map__50651__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__36757__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50655){var e__48594__auto__ = e50655;
return false;
}})();
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
...
}catch (e50657){var e__48594__auto__ = e50657;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50659 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50660 = opts;
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50659;
}});
...
;
var temp__4655__auto___50664 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___50664)){
var managed_print_level_50665 = temp__4655__auto___50664;
var _STAR_print_level_STAR_50663_50666 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50665;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50663_50666,managed_print_level_50665,temp__4655__auto___50664,writer,opts,job_fn){
return (function (p1__50662_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50662_SHARP_,null);
});})(_STAR_print_level_STAR_50663_50666,managed_print_level_50665,temp__4655__auto___50664,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50663_50666;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1503441683849