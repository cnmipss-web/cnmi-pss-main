...
var len__37889__auto___50190 = arguments.length;
var i__37890__auto___50191 = (0);
while(true){
if((i__37890__auto___50191 < len__37889__auto___50190)){
args__37896__auto__.push((arguments[i__37890__auto___50191]));

var G__50192 = (i__37890__auto___50191 + (1));
i__37890__auto___50191 = G__50192;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37897__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50187){
var G__50188 = cljs.core.first.call(null,seq50187);
var seq50187__$1 = cljs.core.next.call(null,seq50187);
var G__50189 = cljs.core.first.call(null,seq50187__$1);
var seq50187__$2 = cljs.core.next.call(null,seq50187__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50188,G__50189,seq50187__$2);
});
...
if(cljs.core.truth_((function (){var or__36763__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__37374__auto__,writer__37375__auto__,opt__37376__auto__){
return cljs.core._write.call(null,writer__37375__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__36751__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__36751__auto__){
var or__36763__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50193_SHARP_){
return !((cljs.core.meta.call(null,p1__50193_SHARP_) == null));
})))){
...
var map__50194 = opts;
var map__50194__$1 = ((((!((map__50194 == null)))?((((map__50194.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50194.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50194):map__50194);
var markup_db = cljs.core.get.call(null,map__50194__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__36763__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50198){var e__48137__auto__ = e50198;
return false;
}})();
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
...
}catch (e50200){var e__48137__auto__ = e50200;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50202 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50203 = opts;
...
var markup_db = cljs.core.get.call(null,map__50203__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50202;
}});
...
;
var temp__4655__auto___50207 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___50207)){
var managed_print_level_50208 = temp__4655__auto___50207;
var _STAR_print_level_STAR_50206_50209 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50208;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50206_50209,managed_print_level_50208,temp__4655__auto___50207,writer,opts,job_fn){
return (function (p1__50205_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50205_SHARP_,null);
});})(_STAR_print_level_STAR_50206_50209,managed_print_level_50208,temp__4655__auto___50207,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50206_50209;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1502260269372