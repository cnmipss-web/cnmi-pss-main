...
var len__27054__auto___39180 = arguments.length;
var i__27055__auto___39181 = (0);
while(true){
if((i__27055__auto___39181 < len__27054__auto___39180)){
args__27061__auto__.push((arguments[i__27055__auto___39181]));

var G__39182 = (i__27055__auto___39181 + (1));
i__27055__auto___39181 = G__39182;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39177){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39178,G__39179,seq39177__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39183_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__39183_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__39192__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e39196){var e__36643__auto__ = e39196;
return false;
}})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
...
}catch (e39198){var e__36643__auto__ = e39198;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39203 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39204 = opts;
var map__39204__$1 = ((((!((map__39204 == null)))?((((map__39204.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39204.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39204):map__39204);
var markup_db = cljs.core.get.call(null,map__39204__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39203;
}});
...
;
var temp__4655__auto___39209 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39209)){
var managed_print_level_39210 = temp__4655__auto___39209;
var _STAR_print_level_STAR_39208_39211 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39210;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39208_39211,managed_print_level_39210,temp__4655__auto___39209,writer,opts,job_fn){
return (function (p1__39206_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39206_SHARP_,null);
});})(_STAR_print_level_STAR_39208_39211,managed_print_level_39210,temp__4655__auto___39209,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39208_39211;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1498622393158