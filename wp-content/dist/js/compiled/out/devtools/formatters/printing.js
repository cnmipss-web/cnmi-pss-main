...
var len__37881__auto___50561 = arguments.length;
var i__37882__auto___50562 = (0);
while(true){
if((i__37882__auto___50562 < len__37881__auto___50561)){
args__37888__auto__.push((arguments[i__37882__auto___50562]));

var G__50563 = (i__37882__auto___50562 + (1));
i__37882__auto___50562 = G__50563;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50558){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50559,G__50560,seq50558__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50564_SHARP_){
return !((cljs.core.meta.call(null,p1__50564_SHARP_) == null));
})))){
...
var map__50565 = opts;
var map__50565__$1 = ((((!((map__50565 == null)))?((((map__50565.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50565.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50565):map__50565);
var markup_db = cljs.core.get.call(null,map__50565__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e50569){var e__48597__auto__ = e50569;
return false;
}})();
if(cljs.core.truth_(or__36756__auto__)){
return or__36756__auto__;
...
}catch (e50571){var e__48597__auto__ = e50571;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50573 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50574 = opts;
...
var markup_db = cljs.core.get.call(null,map__50574__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50573;
}});
...
;
var temp__4655__auto___50578 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___50578)){
var managed_print_level_50579 = temp__4655__auto___50578;
var _STAR_print_level_STAR_50577_50580 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50579;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50577_50580,managed_print_level_50579,temp__4655__auto___50578,writer,opts,job_fn){
return (function (p1__50576_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50576_SHARP_,null);
});})(_STAR_print_level_STAR_50577_50580,managed_print_level_50579,temp__4655__auto___50578,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50577_50580;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1503550047753