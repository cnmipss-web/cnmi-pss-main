...
var len__37881__auto___50714 = arguments.length;
var i__37882__auto___50715 = (0);
while(true){
if((i__37882__auto___50715 < len__37881__auto___50714)){
args__37888__auto__.push((arguments[i__37882__auto___50715]));

var G__50716 = (i__37882__auto___50715 + (1));
i__37882__auto___50715 = G__50716;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37889__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50711){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50712,G__50713,seq50711__$2);
});
...
if(cljs.core.truth_((function (){var or__36756__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__37367__auto__,writer__37368__auto__,opt__37369__auto__){
return cljs.core._write.call(null,writer__37368__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__36744__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__36744__auto__){
var or__36756__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__36756__auto__)){
return or__36756__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50717_SHARP_){
return !((cljs.core.meta.call(null,p1__50717_SHARP_) == null));
})))){
...
var map__50718 = opts;
var map__50718__$1 = ((((!((map__50718 == null)))?((((map__50718.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50718.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50718):map__50718);
var markup_db = cljs.core.get.call(null,map__50718__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__36756__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50722){var e__48760__auto__ = e50722;
return false;
}})();
if(cljs.core.truth_(or__36756__auto__)){
return or__36756__auto__;
...
}catch (e50724){var e__48760__auto__ = e50724;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50726 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50727 = opts;
...
var markup_db = cljs.core.get.call(null,map__50727__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50726;
}});
...
;
var temp__4655__auto___50731 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___50731)){
var managed_print_level_50732 = temp__4655__auto___50731;
var _STAR_print_level_STAR_50730_50733 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50732;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50730_50733,managed_print_level_50732,temp__4655__auto___50731,writer,opts,job_fn){
return (function (p1__50729_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50729_SHARP_,null);
});})(_STAR_print_level_STAR_50730_50733,managed_print_level_50732,temp__4655__auto___50731,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50730_50733;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1503532149029