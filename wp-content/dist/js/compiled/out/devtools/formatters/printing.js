...
var len__28177__auto___50778 = arguments.length;
var i__28178__auto___50779 = (0);
while(true){
if((i__28178__auto___50779 < len__28177__auto___50778)){
args__28184__auto__.push((arguments[i__28178__auto___50779]));

var G__50780 = (i__28178__auto___50779 + (1));
i__28178__auto___50779 = G__50780;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28185__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50775){
var G__50776 = cljs.core.first.call(null,seq50775);
var seq50775__$1 = cljs.core.next.call(null,seq50775);
var G__50777 = cljs.core.first.call(null,seq50775__$1);
var seq50775__$2 = cljs.core.next.call(null,seq50775__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__50776,G__50777,seq50775__$2);
});
...
if(cljs.core.truth_((function (){var or__27052__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__27663__auto__,writer__27664__auto__,opt__27665__auto__){
return cljs.core._write.call(null,writer__27664__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27040__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27040__auto__){
var or__27052__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27052__auto__)){
return or__27052__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50781_SHARP_){
return !((cljs.core.meta.call(null,p1__50781_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__50782__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27052__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e50786){var e__37835__auto__ = e50786;
return false;
}})();
if(cljs.core.truth_(or__27052__auto__)){
return or__27052__auto__;
...
}catch (e50788){var e__37835__auto__ = e50788;
return false;
}}
})())){
...
var _STAR_current_state_STAR_50790 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__50791 = opts;
var map__50791__$1 = ((((!((map__50791 == null)))?((((map__50791.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50791.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50791):map__50791);
var markup_db = cljs.core.get.call(null,map__50791__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_50790;
}});
...
;
var temp__4655__auto___50795 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___50795)){
var managed_print_level_50796 = temp__4655__auto___50795;
var _STAR_print_level_STAR_50794_50797 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_50796;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_50794_50797,managed_print_level_50796,temp__4655__auto___50795,writer,opts,job_fn){
return (function (p1__50793_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50793_SHARP_,null);
});})(_STAR_print_level_STAR_50794_50797,managed_print_level_50796,temp__4655__auto___50795,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_50794_50797;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1501568775615