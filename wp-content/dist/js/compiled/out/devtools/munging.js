...
var temp__4657__auto____$1 = goog.object.get(o__48582__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__48581__auto__ = temp__4657__auto____$1;
return goog.object.get(o__48581__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__48569__auto__ = f;
return goog.object.get(o__48569__auto__,"toString").call(o__48569__auto__);
}catch (e50520){var _ = e50520;
return "";
}});
...
try{var o__48569__auto___50522 = t;
goog.object.get(o__48569__auto___50522,"cljs$lang$ctorPrWriter").call(o__48569__auto___50522,t,writer);
}catch (e50521){var __50523 = e50521;
}
...
var char_code = (function (){var o__48569__auto__ = (new String(char$));
return goog.object.get(o__48569__auto__,"charCodeAt").call(o__48569__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__48569__auto__ = String;
return goog.object.get(o__48569__auto__,"fromCharCode").call(o__48569__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50524 = num_code;
switch (G__50524) {
case (1):
return (185);
...
var o__48569__auto__ = String;
return goog.object.get(o__48569__auto__,"fromCharCode").call(o__48569__auto__,superscript_code);
});
/**
...
}catch (e50526){var e__48594__auto__ = e50526;
return false;
}})())){
...
var vec__50527 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50527,(0),null);
...
var or__36757__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__48582__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__48582__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__48581__auto__ = temp__4657__auto____$1;
return goog.object.get(o__48581__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__37882__auto___50536 = arguments.length;
var i__37883__auto___50537 = (0);
while(true){
if((i__37883__auto___50537 < len__37882__auto___50536)){
args__37889__auto__.push((arguments[i__37883__auto___50537]));

var G__50538 = (i__37883__auto___50537 + (1));
i__37883__auto___50537 = G__50538;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__37890__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50532){
var vec__50533 = p__50532;
var ns_detector = cljs.core.nth.call(null,vec__50533,(0),null);
var effective_detector = (function (){var or__36757__auto__ = ns_detector;
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
var G__50539 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50540 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50539;
remaining_tokens = G__50540;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50530){
var G__50531 = cljs.core.first.call(null,seq50530);
var seq50530__$1 = cljs.core.next.call(null,seq50530);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50531,seq50530__$1);
});
...
var vec__50544 = cljs.core.split_with.call(null,(function (p1__50543_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50543_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50544,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50544,(1),null);
...
var vec__50547 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50547,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50547,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50550 = cljs.core.rest.call(null,remaining_tokens);
var G__50551 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50550;
name_tokens = G__50551;
continue;
} else {
...
var vec__50554 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50554,(0),null);
var arity = cljs.core.nth.call(null,vec__50554,(1),null);
var vec__50557 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50557,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50557,(1),null);
var vec__50560 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50560,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50560,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50560,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50560,(3),null);
...
var vec__50566 = result;
var munged_ns = cljs.core.nth.call(null,vec__50566,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50566,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50566,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50566,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50566,(4),null);
var arity = cljs.core.nth.call(null,vec__50566,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__50570 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__50570,(0),null);
var args = cljs.core.nth.call(null,vec__50570,(1),null);
var vec__50573 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50573,(0),null);
var name = cljs.core.nth.call(null,vec__50573,(1),null);
...
var G__50576 = (arity + (1));
var G__50577 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50578){
var vec__50579 = p__50578;
var arity = cljs.core.nth.call(null,vec__50579,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50579,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__36757__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__50582_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__50583_SHARP_);
...
var args__37889__auto__ = [];
var len__37882__auto___50590 = arguments.length;
var i__37883__auto___50591 = (0);
while(true){
if((i__37883__auto___50591 < len__37882__auto___50590)){
args__37889__auto__.push((arguments[i__37883__auto___50591]));

var G__50592 = (i__37883__auto___50591 + (1));
i__37883__auto___50591 = G__50592;
continue;
} else {
}
break;
...
var argseq__37890__auto__ = ((((1) < args__37889__auto__.length))?(new cljs.core.IndexedSeq(args__37889__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__37890__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50586){
var vec__50587 = p__50586;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50587,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50584){
var G__50585 = cljs.core.first.call(null,seq50584);
var seq50584__$1 = cljs.core.next.call(null,seq50584);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50585,seq50584__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__36757__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__36745__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__36757__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__50595__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50595__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50595__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50595__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50596 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50596,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50596,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50596,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50596,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50596,(4),null);
var arity = cljs.core.nth.call(null,vec__50596,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__36745__auto__ = protocol_ns;
if(cljs.core.truth_(and__36745__auto__)){
return cljs.core.not.call(null,(function (){var and__36745__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__36757__auto__ = protocol_part;
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
return fn_part;
...
var o__48569__auto__ = f;
return goog.object.get(o__48569__auto__,"getBasis").call(o__48569__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__36745__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__36745__auto__)){
...
}catch (e50600){var e__48594__auto__ = e50600;
...
var G__50601 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__50602 = cljs.core.rest.call(null,path);
obj = G__50601;
path = G__50602;
continue;
} else {
...
var partition_bits = (function (){var or__36757__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__36757__auto__)){
return or__36757__auto__;
} else {
return (0);
...
return (function (accum,p__50603){
var vec__50604 = p__50603;
var bit = cljs.core.nth.call(null,vec__50604,(0),null);
var protocol = cljs.core.nth.call(null,vec__50604,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50607){
var vec__50608 = p__50607;
var ns = cljs.core.nth.call(null,vec__50608,(0),null);
var name = cljs.core.nth.call(null,vec__50608,(1),null);
var selector = cljs.core.nth.call(null,vec__50608,(2),null);
...
return (function (p__50612){
var vec__50613 = p__50612;
var munged_name = cljs.core.nth.call(null,vec__50613,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50613,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50613,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50611_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__50611_SHARP_));
});})(name,sorted_matches,vec__50613,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503441683689