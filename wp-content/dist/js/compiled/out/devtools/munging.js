...
var temp__4657__auto____$1 = goog.object.get(o__48125__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__48124__auto__ = temp__4657__auto____$1;
return goog.object.get(o__48124__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__48112__auto__ = f;
return goog.object.get(o__48112__auto__,"toString").call(o__48112__auto__);
}catch (e50063){var _ = e50063;
return "";
}});
...
try{var o__48112__auto___50065 = t;
goog.object.get(o__48112__auto___50065,"cljs$lang$ctorPrWriter").call(o__48112__auto___50065,t,writer);
}catch (e50064){var __50066 = e50064;
}
...
var char_code = (function (){var o__48112__auto__ = (new String(char$));
return goog.object.get(o__48112__auto__,"charCodeAt").call(o__48112__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__48112__auto__ = String;
return goog.object.get(o__48112__auto__,"fromCharCode").call(o__48112__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50067 = num_code;
switch (G__50067) {
case (1):
return (185);
...
var o__48112__auto__ = String;
return goog.object.get(o__48112__auto__,"fromCharCode").call(o__48112__auto__,superscript_code);
});
/**
...
}catch (e50069){var e__48137__auto__ = e50069;
return false;
}})())){
...
var vec__50070 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50070,(0),null);
...
var or__36763__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__48125__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__48125__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__48124__auto__ = temp__4657__auto____$1;
return goog.object.get(o__48124__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__37889__auto___50079 = arguments.length;
var i__37890__auto___50080 = (0);
while(true){
if((i__37890__auto___50080 < len__37889__auto___50079)){
args__37896__auto__.push((arguments[i__37890__auto___50080]));

var G__50081 = (i__37890__auto___50080 + (1));
i__37890__auto___50080 = G__50081;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__37897__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50075){
var vec__50076 = p__50075;
var ns_detector = cljs.core.nth.call(null,vec__50076,(0),null);
var effective_detector = (function (){var or__36763__auto__ = ns_detector;
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
var G__50082 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50083 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50082;
remaining_tokens = G__50083;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50073){
var G__50074 = cljs.core.first.call(null,seq50073);
var seq50073__$1 = cljs.core.next.call(null,seq50073);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50074,seq50073__$1);
});
...
var vec__50087 = cljs.core.split_with.call(null,(function (p1__50086_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50086_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50087,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50087,(1),null);
...
var vec__50090 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50090,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50090,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50093 = cljs.core.rest.call(null,remaining_tokens);
var G__50094 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50093;
name_tokens = G__50094;
continue;
} else {
...
var vec__50097 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50097,(0),null);
var arity = cljs.core.nth.call(null,vec__50097,(1),null);
var vec__50100 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50100,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50100,(1),null);
var vec__50103 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50103,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50103,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50103,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50103,(3),null);
...
var vec__50109 = result;
var munged_ns = cljs.core.nth.call(null,vec__50109,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50109,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50109,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50109,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50109,(4),null);
var arity = cljs.core.nth.call(null,vec__50109,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__50113 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__50113,(0),null);
var args = cljs.core.nth.call(null,vec__50113,(1),null);
var vec__50116 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50116,(0),null);
var name = cljs.core.nth.call(null,vec__50116,(1),null);
...
var G__50119 = (arity + (1));
var G__50120 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50121){
var vec__50122 = p__50121;
var arity = cljs.core.nth.call(null,vec__50122,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50122,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__36763__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__50125_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__50126_SHARP_);
...
var args__37896__auto__ = [];
var len__37889__auto___50133 = arguments.length;
var i__37890__auto___50134 = (0);
while(true){
if((i__37890__auto___50134 < len__37889__auto___50133)){
args__37896__auto__.push((arguments[i__37890__auto___50134]));

var G__50135 = (i__37890__auto___50134 + (1));
i__37890__auto___50134 = G__50135;
continue;
} else {
}
break;
...
var argseq__37897__auto__ = ((((1) < args__37896__auto__.length))?(new cljs.core.IndexedSeq(args__37896__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__37897__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50129){
var vec__50130 = p__50129;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50130,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50127){
var G__50128 = cljs.core.first.call(null,seq50127);
var seq50127__$1 = cljs.core.next.call(null,seq50127);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50128,seq50127__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__36763__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__36751__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__36763__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__50138__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50138__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50138__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50138__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50139 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50139,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50139,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50139,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50139,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50139,(4),null);
var arity = cljs.core.nth.call(null,vec__50139,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__36751__auto__ = protocol_ns;
if(cljs.core.truth_(and__36751__auto__)){
return cljs.core.not.call(null,(function (){var and__36751__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__36763__auto__ = protocol_part;
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
return fn_part;
...
var o__48112__auto__ = f;
return goog.object.get(o__48112__auto__,"getBasis").call(o__48112__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__36751__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__36751__auto__)){
...
}catch (e50143){var e__48137__auto__ = e50143;
...
var G__50144 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__50145 = cljs.core.rest.call(null,path);
obj = G__50144;
path = G__50145;
continue;
} else {
...
var partition_bits = (function (){var or__36763__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__36763__auto__)){
return or__36763__auto__;
} else {
return (0);
...
return (function (accum,p__50146){
var vec__50147 = p__50146;
var bit = cljs.core.nth.call(null,vec__50147,(0),null);
var protocol = cljs.core.nth.call(null,vec__50147,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50150){
var vec__50151 = p__50150;
var ns = cljs.core.nth.call(null,vec__50151,(0),null);
var name = cljs.core.nth.call(null,vec__50151,(1),null);
var selector = cljs.core.nth.call(null,vec__50151,(2),null);
...
return (function (p__50155){
var vec__50156 = p__50155;
var munged_name = cljs.core.nth.call(null,vec__50156,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50156,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50156,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50154_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__50154_SHARP_));
});})(name,sorted_matches,vec__50156,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1502260269202