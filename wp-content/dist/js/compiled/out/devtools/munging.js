...
var temp__4657__auto____$1 = goog.object.get(o__48748__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__48747__auto__ = temp__4657__auto____$1;
return goog.object.get(o__48747__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__48735__auto__ = f;
return goog.object.get(o__48735__auto__,"toString").call(o__48735__auto__);
}catch (e50587){var _ = e50587;
return "";
}});
...
try{var o__48735__auto___50589 = t;
goog.object.get(o__48735__auto___50589,"cljs$lang$ctorPrWriter").call(o__48735__auto___50589,t,writer);
}catch (e50588){var __50590 = e50588;
}
...
var char_code = (function (){var o__48735__auto__ = (new String(char$));
return goog.object.get(o__48735__auto__,"charCodeAt").call(o__48735__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__48735__auto__ = String;
return goog.object.get(o__48735__auto__,"fromCharCode").call(o__48735__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__50591 = num_code;
switch (G__50591) {
case (1):
return (185);
...
var o__48735__auto__ = String;
return goog.object.get(o__48735__auto__,"fromCharCode").call(o__48735__auto__,superscript_code);
});
/**
...
}catch (e50593){var e__48760__auto__ = e50593;
return false;
}})())){
...
var vec__50594 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50594,(0),null);
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__48748__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__48748__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__48747__auto__ = temp__4657__auto____$1;
return goog.object.get(o__48747__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__37881__auto___50603 = arguments.length;
var i__37882__auto___50604 = (0);
while(true){
if((i__37882__auto___50604 < len__37881__auto___50603)){
args__37888__auto__.push((arguments[i__37882__auto___50604]));

var G__50605 = (i__37882__auto___50604 + (1));
i__37882__auto___50604 = G__50605;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50599){
var vec__50600 = p__50599;
var ns_detector = cljs.core.nth.call(null,vec__50600,(0),null);
...
var G__50606 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50607 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50606;
remaining_tokens = G__50607;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50597){
var G__50598 = cljs.core.first.call(null,seq50597);
var seq50597__$1 = cljs.core.next.call(null,seq50597);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__50598,seq50597__$1);
});
...
var vec__50611 = cljs.core.split_with.call(null,(function (p1__50610_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50610_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50611,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50611,(1),null);
...
var vec__50614 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50614,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50614,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50617 = cljs.core.rest.call(null,remaining_tokens);
var G__50618 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50617;
name_tokens = G__50618;
continue;
} else {
...
var vec__50621 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50621,(0),null);
var arity = cljs.core.nth.call(null,vec__50621,(1),null);
var vec__50624 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50624,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50624,(1),null);
var vec__50627 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50627,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50627,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50627,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50627,(3),null);
...
var vec__50633 = result;
var munged_ns = cljs.core.nth.call(null,vec__50633,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50633,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50633,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50633,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50633,(4),null);
var arity = cljs.core.nth.call(null,vec__50633,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__50637 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__50637,(0),null);
var args = cljs.core.nth.call(null,vec__50637,(1),null);
var vec__50640 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50640,(0),null);
var name = cljs.core.nth.call(null,vec__50640,(1),null);
...
var G__50643 = (arity + (1));
var G__50644 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50645){
var vec__50646 = p__50645;
var arity = cljs.core.nth.call(null,vec__50646,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50646,(1),null);
...
return (function (p1__50649_SHARP_){
return cljs.core.get.call(null,arities,p1__50649_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__50650_SHARP_);
...
var args__37888__auto__ = [];
var len__37881__auto___50657 = arguments.length;
var i__37882__auto___50658 = (0);
while(true){
if((i__37882__auto___50658 < len__37881__auto___50657)){
args__37888__auto__.push((arguments[i__37882__auto___50658]));

var G__50659 = (i__37882__auto___50658 + (1));
i__37882__auto___50658 = G__50659;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50653){
var vec__50654 = p__50653;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50654,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50651){
var G__50652 = cljs.core.first.call(null,seq50651);
var seq50651__$1 = cljs.core.next.call(null,seq50651);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__50652,seq50651__$1);
});
...
var map__50662 = options;
var map__50662__$1 = ((((!((map__50662 == null)))?((((map__50662.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50662.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50662):map__50662);
var include_ns_QMARK_ = cljs.core.get.call(null,map__50662__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50662__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50662__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50662__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50663 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50663,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50663,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50663,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50663,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50663,(4),null);
var arity = cljs.core.nth.call(null,vec__50663,(5),null);
...
var o__48735__auto__ = f;
return goog.object.get(o__48735__auto__,"getBasis").call(o__48735__auto__);
});
/**
...
}catch (e50667){var e__48760__auto__ = e50667;
...
var G__50668 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__50669 = cljs.core.rest.call(null,path);
obj = G__50668;
path = G__50669;
continue;
} else {
...
return (function (accum,p__50670){
var vec__50671 = p__50670;
var bit = cljs.core.nth.call(null,vec__50671,(0),null);
var protocol = cljs.core.nth.call(null,vec__50671,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50674){
var vec__50675 = p__50674;
var ns = cljs.core.nth.call(null,vec__50675,(0),null);
var name = cljs.core.nth.call(null,vec__50675,(1),null);
var selector = cljs.core.nth.call(null,vec__50675,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__50680,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50680,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__50680,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__50678_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__50678_SHARP_));
});})(name,sorted_matches,vec__50680,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503532148884