...
var temp__4657__auto____$1 = goog.object.get(o__38266__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__38265__auto__ = temp__4657__auto____$1;
return goog.object.get(o__38265__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__38253__auto__ = f;
return goog.object.get(o__38253__auto__,"toString").call(o__38253__auto__);
}catch (e40626){var _ = e40626;
return "";
}});
...
try{var o__38253__auto___40629 = t;
goog.object.get(o__38253__auto___40629,"cljs$lang$ctorPrWriter").call(o__38253__auto___40629,t,writer);
}catch (e40628){var __40630 = e40628;
}
...
var char_code = (function (){var o__38253__auto__ = (new String(char$));
return goog.object.get(o__38253__auto__,"charCodeAt").call(o__38253__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38253__auto__ = String;
return goog.object.get(o__38253__auto__,"fromCharCode").call(o__38253__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40632 = num_code;
switch (G__40632) {
case (1):
return (185);
...
var o__38253__auto__ = String;
return goog.object.get(o__38253__auto__,"fromCharCode").call(o__38253__auto__,superscript_code);
});
/**
...
}catch (e40638){var e__38278__auto__ = e40638;
return false;
}})())){
...
var vec__40639 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40639,(0),null);
...
var or__25989__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__38266__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__38266__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__38265__auto__ = temp__4657__auto____$1;
return goog.object.get(o__38265__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27064__auto___40648 = arguments.length;
var i__27065__auto___40649 = (0);
while(true){
if((i__27065__auto___40649 < len__27064__auto___40648)){
args__27071__auto__.push((arguments[i__27065__auto___40649]));

var G__40650 = (i__27065__auto___40649 + (1));
i__27065__auto___40649 = G__40650;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27072__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40644){
var vec__40645 = p__40644;
var ns_detector = cljs.core.nth.call(null,vec__40645,(0),null);
var effective_detector = (function (){var or__25989__auto__ = ns_detector;
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
...
var G__40651 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40652 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40651;
remaining_tokens = G__40652;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40642){
var G__40643 = cljs.core.first.call(null,seq40642);
var seq40642__$1 = cljs.core.next.call(null,seq40642);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40643,seq40642__$1);
});
...
var vec__40660 = cljs.core.split_with.call(null,(function (p1__40656_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40656_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40660,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40660,(1),null);
...
var vec__40666 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40666,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40666,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40669 = cljs.core.rest.call(null,remaining_tokens);
var G__40670 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40669;
name_tokens = G__40670;
continue;
} else {
...
var args40671 = [];
var len__27064__auto___40683 = arguments.length;
var i__27065__auto___40684 = (0);
while(true){
if((i__27065__auto___40684 < len__27064__auto___40683)){
args40671.push((arguments[i__27065__auto___40684]));

var G__40685 = (i__27065__auto___40684 + (1));
i__27065__auto___40684 = G__40685;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args40671.length)].join('')));
...
var vec__40674 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40674,(0),null);
var arity = cljs.core.nth.call(null,vec__40674,(1),null);
var vec__40677 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40677,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40677,(1),null);
var vec__40680 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40680,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40680,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40680,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40680,(3),null);
...
var args40687 = [];
var len__27064__auto___40693 = arguments.length;
var i__27065__auto___40694 = (0);
while(true){
if((i__27065__auto___40694 < len__27064__auto___40693)){
args40687.push((arguments[i__27065__auto___40694]));

var G__40695 = (i__27065__auto___40694 + (1));
i__27065__auto___40694 = G__40695;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args40687.length)].join('')));
...
var vec__40690 = result;
var munged_ns = cljs.core.nth.call(null,vec__40690,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40690,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40690,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40690,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40690,(4),null);
var arity = cljs.core.nth.call(null,vec__40690,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__40703 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__40703,(0),null);
var args = cljs.core.nth.call(null,vec__40703,(1),null);
var vec__40706 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40706,(0),null);
var name = cljs.core.nth.call(null,vec__40706,(1),null);
...
var G__40709 = (arity + (1));
var G__40710 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40711){
var vec__40715 = p__40711;
var arity = cljs.core.nth.call(null,vec__40715,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40715,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__25989__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__40718_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40719_SHARP_);
...
var args__27071__auto__ = [];
var len__27064__auto___40726 = arguments.length;
var i__27065__auto___40727 = (0);
while(true){
if((i__27065__auto___40727 < len__27064__auto___40726)){
args__27071__auto__.push((arguments[i__27065__auto___40727]));

var G__40728 = (i__27065__auto___40727 + (1));
i__27065__auto___40727 = G__40728;
continue;
} else {
}
break;
...
var argseq__27072__auto__ = ((((1) < args__27071__auto__.length))?(new cljs.core.IndexedSeq(args__27071__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27072__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40722){
var vec__40723 = p__40722;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40723,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40720){
var G__40721 = cljs.core.first.call(null,seq40720);
var seq40720__$1 = cljs.core.next.call(null,seq40720);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40721,seq40720__$1);
});
...
var G__40730 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__40730) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__25989__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__25977__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__25989__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
...
var map__40737 = options;
var map__40737__$1 = ((((!((map__40737 == null)))?((((map__40737.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40737.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40737):map__40737);
var include_ns_QMARK_ = cljs.core.get.call(null,map__40737__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40737__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40737__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40737__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40738 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40738,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40738,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40738,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40738,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40738,(4),null);
var arity = cljs.core.nth.call(null,vec__40738,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__25977__auto__ = protocol_ns;
if(cljs.core.truth_(and__25977__auto__)){
return cljs.core.not.call(null,(function (){var and__25977__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__25989__auto__ = protocol_part;
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
return fn_part;
...
var o__38253__auto__ = f;
return goog.object.get(o__38253__auto__,"getBasis").call(o__38253__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__25977__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25977__auto__)){
...
}catch (e40743){var e__38278__auto__ = e40743;
...
var G__40744 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__40745 = cljs.core.rest.call(null,path);
obj = G__40744;
path = G__40745;
continue;
} else {
...
var partition_bits = (function (){var or__25989__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__25989__auto__)){
return or__25989__auto__;
} else {
return (0);
...
return (function (accum,p__40750){
var vec__40751 = p__40750;
var bit = cljs.core.nth.call(null,vec__40751,(0),null);
var protocol = cljs.core.nth.call(null,vec__40751,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40754){
var vec__40758 = p__40754;
var ns = cljs.core.nth.call(null,vec__40758,(0),null);
var name = cljs.core.nth.call(null,vec__40758,(1),null);
var selector = cljs.core.nth.call(null,vec__40758,(2),null);
...
return (function (p__40766){
var vec__40767 = p__40766;
var munged_name = cljs.core.nth.call(null,vec__40767,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40767,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40767,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40761_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__40761_SHARP_));
});})(name,sorted_matches,vec__40767,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1500616867791