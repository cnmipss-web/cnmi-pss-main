...
var vec__42211_42214 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_42215 = cljs.core.nth.call(null,vec__42211_42214,(0),null);
var only_after_42216 = cljs.core.nth.call(null,vec__42211_42214,(1),null);
var db_changed_QMARK__42217 = (!((only_before_42215 == null))) || (!((only_after_42216 == null)));
if(db_changed_QMARK__42217){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_42215);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_42216);
...
var map__42218 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__42218__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__42218__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__42220 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__42220__$1;
var event = cljs.core.get.call(null,map__42220__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__37894__auto___42223 = arguments.length;
var i__37895__auto___42224 = (0);
while(true){
if((i__37895__auto___42224 < len__37894__auto___42223)){
args__37901__auto__.push((arguments[i__37895__auto___42224]));

var G__42225 = (i__37895__auto___42224 + (1));
i__37895__auto___42224 = G__42225;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__37902__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq42222){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42222));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__36769__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__37901__auto__ = [];
var len__37894__auto___42231 = arguments.length;
var i__37895__auto___42232 = (0);
while(true){
if((i__37895__auto___42232 < len__37894__auto___42231)){
args__37901__auto__.push((arguments[i__37895__auto___42232]));

var G__42233 = (i__37895__auto___42232 + (1));
i__37895__auto___42232 = G__42233;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37902__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__42226_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__42227_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__42227_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq42228){
var G__42229 = cljs.core.first.call(null,seq42228);
var seq42228__$1 = cljs.core.next.call(null,seq42228);
var G__42230 = cljs.core.first.call(null,seq42228__$1);
var seq42228__$2 = cljs.core.next.call(null,seq42228__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__42229,G__42230,seq42228__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1502846509386