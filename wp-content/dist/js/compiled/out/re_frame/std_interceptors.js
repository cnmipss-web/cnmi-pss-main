...
var vec__42199_42202 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_42203 = cljs.core.nth.call(null,vec__42199_42202,(0),null);
var only_after_42204 = cljs.core.nth.call(null,vec__42199_42202,(1),null);
var db_changed_QMARK__42205 = (!((only_before_42203 == null))) || (!((only_after_42204 == null)));
if(db_changed_QMARK__42205){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_42203);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_42204);
...
var map__42206 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__42206__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__42206__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__42208 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__42208__$1;
var event = cljs.core.get.call(null,map__42208__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__37882__auto___42211 = arguments.length;
var i__37883__auto___42212 = (0);
while(true){
if((i__37883__auto___42212 < len__37882__auto___42211)){
args__37889__auto__.push((arguments[i__37883__auto___42212]));

var G__42213 = (i__37883__auto___42212 + (1));
i__37883__auto___42212 = G__42213;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__37890__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq42210){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq42210));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__36757__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__37889__auto__ = [];
var len__37882__auto___42219 = arguments.length;
var i__37883__auto___42220 = (0);
while(true){
if((i__37883__auto___42220 < len__37882__auto___42219)){
args__37889__auto__.push((arguments[i__37883__auto___42220]));

var G__42221 = (i__37883__auto___42220 + (1));
i__37883__auto___42220 = G__42221;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37890__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__42214_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__42215_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__42215_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq42216){
var G__42217 = cljs.core.first.call(null,seq42216);
var seq42216__$1 = cljs.core.next.call(null,seq42216);
var G__42218 = cljs.core.first.call(null,seq42216__$1);
var seq42216__$2 = cljs.core.next.call(null,seq42216__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__42217,G__42218,seq42216__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1503441675390