...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__39858 = cljs.core.instance_QMARK_;
var expr__39859 = reactive_val;
if(cljs.core.truth_(pred__39858.call(null,reagent.ratom.RAtom,expr__39859))){
return "ra";
} else {
if(cljs.core.truth_(pred__39858.call(null,reagent.ratom.RCursor,expr__39859))){
return "rc";
} else {
if(cljs.core.truth_(pred__39858.call(null,reagent.ratom.Reaction,expr__39859))){
return "rx";
} else {
if(cljs.core.truth_(pred__39858.call(null,reagent.ratom.Track,expr__39859))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1503532138201