...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__40974 = cljs.core.instance_QMARK_;
var expr__40975 = reactive_val;
if(cljs.core.truth_(pred__40974.call(null,reagent.ratom.RAtom,expr__40975))){
return "ra";
} else {
if(cljs.core.truth_(pred__40974.call(null,reagent.ratom.RCursor,expr__40975))){
return "rc";
} else {
if(cljs.core.truth_(pred__40974.call(null,reagent.ratom.Reaction,expr__40975))){
return "rx";
} else {
if(cljs.core.truth_(pred__40974.call(null,reagent.ratom.Track,expr__40975))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1503550038240