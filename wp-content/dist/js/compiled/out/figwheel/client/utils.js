...
var or__36769__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj40102 = {"detail":data};
return obj40102;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__36757__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__36757__auto__)){
var and__36757__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__40109 = cljs.core._EQ_;
var expr__40110 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__40109.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__40110))){
return ((function (pred__40109,expr__40110){
return (function (p1__40103_SHARP_){
return console.warn(p1__40103_SHARP_);
});
;})(pred__40109,expr__40110))
} else {
if(cljs.core.truth_(pred__40109.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__40110))){
return ((function (pred__40109,expr__40110){
return (function (p1__40104_SHARP_){
return console.debug(p1__40104_SHARP_);
});
;})(pred__40109,expr__40110))
} else {
if(cljs.core.truth_(pred__40109.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__40110))){
return ((function (pred__40109,expr__40110){
return (function (p1__40105_SHARP_){
return console.error(p1__40105_SHARP_);
});
;})(pred__40109,expr__40110))
} else {
return ((function (pred__40109,expr__40110){
return (function (p1__40106_SHARP_){
return console.log(p1__40106_SHARP_);
});
;})(pred__40109,expr__40110))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__40113){
...
var opts = map__40114__$1;
var eval_fn = cljs.core.get.call(null,map__40114__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__40116_SHARP_){
return new_def.callback(p1__40116_SHARP_);
});})(new_def))
);
...
return (function (p__40117){
var vec__40118 = p__40117;
var ky = cljs.core.nth.call(null,vec__40118,(0),null);
...
if(cljs.core.truth_((function (){var and__36757__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1502846506511