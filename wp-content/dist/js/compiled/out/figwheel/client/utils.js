...
var or__26956__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj33265 = {"detail":data};
return obj33265;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26944__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26944__auto__)){
var and__26944__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__33272 = cljs.core._EQ_;
var expr__33273 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33272.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33273))){
return ((function (pred__33272,expr__33273){
return (function (p1__33266_SHARP_){
return console.warn(p1__33266_SHARP_);
});
;})(pred__33272,expr__33273))
} else {
if(cljs.core.truth_(pred__33272.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33273))){
return ((function (pred__33272,expr__33273){
return (function (p1__33267_SHARP_){
return console.debug(p1__33267_SHARP_);
});
;})(pred__33272,expr__33273))
} else {
if(cljs.core.truth_(pred__33272.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33273))){
return ((function (pred__33272,expr__33273){
return (function (p1__33268_SHARP_){
return console.error(p1__33268_SHARP_);
});
;})(pred__33272,expr__33273))
} else {
return ((function (pred__33272,expr__33273){
return (function (p1__33269_SHARP_){
return console.log(p1__33269_SHARP_);
});
;})(pred__33272,expr__33273))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33276){
...
var eval_fn = cljs.core.get.call(null,map__33277__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33279_SHARP_);
});})(new_def))
);
...
return (function (p__33280){
var vec__33281 = p__33280;
var ky = cljs.core.nth.call(null,vec__33281,(0),null);
var v = cljs.core.nth.call(null,vec__33281,(1),null);
...
if(cljs.core.truth_((function (){var and__26944__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1500852798295