...
return (new CustomEvent(event_name,(function (){var obj30385 = {"detail":data};
return obj30385;
})()));
} else {
...
var f = (function (){var pred__30392 = cljs.core._EQ_;
var expr__30393 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30392.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30393))){
return ((function (pred__30392,expr__30393){
return (function (p1__30386_SHARP_){
return console.warn(p1__30386_SHARP_);
});
;})(pred__30392,expr__30393))
} else {
if(cljs.core.truth_(pred__30392.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30393))){
return ((function (pred__30392,expr__30393){
return (function (p1__30387_SHARP_){
return console.debug(p1__30387_SHARP_);
});
;})(pred__30392,expr__30393))
} else {
if(cljs.core.truth_(pred__30392.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30393))){
return ((function (pred__30392,expr__30393){
return (function (p1__30388_SHARP_){
return console.error(p1__30388_SHARP_);
});
;})(pred__30392,expr__30393))
} else {
return ((function (pred__30392,expr__30393){
return (function (p1__30389_SHARP_){
return console.log(p1__30389_SHARP_);
});
;})(pred__30392,expr__30393))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30396){
...
var opts = map__30397__$1;
var eval_fn = cljs.core.get.call(null,map__30397__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30399_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30401,(0),null);
var v = cljs.core.nth.call(null,vec__30401,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1501628486489