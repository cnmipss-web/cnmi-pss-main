...
var or__27052__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj47008 = {"detail":data};
return obj47008;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27040__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27040__auto__)){
var and__27040__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__47015 = cljs.core._EQ_;
var expr__47016 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__47015.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__47016))){
return ((function (pred__47015,expr__47016){
return (function (p1__47009_SHARP_){
return console.warn(p1__47009_SHARP_);
});
;})(pred__47015,expr__47016))
} else {
if(cljs.core.truth_(pred__47015.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__47016))){
return ((function (pred__47015,expr__47016){
return (function (p1__47010_SHARP_){
return console.debug(p1__47010_SHARP_);
});
;})(pred__47015,expr__47016))
} else {
if(cljs.core.truth_(pred__47015.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__47016))){
return ((function (pred__47015,expr__47016){
return (function (p1__47011_SHARP_){
return console.error(p1__47011_SHARP_);
});
;})(pred__47015,expr__47016))
} else {
return ((function (pred__47015,expr__47016){
return (function (p1__47012_SHARP_){
return console.log(p1__47012_SHARP_);
});
;})(pred__47015,expr__47016))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__47019){
var map__47020 = p__47019;
var map__47020__$1 = ((((!((map__47020 == null)))?((((map__47020.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47020.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47020):map__47020);
var opts = map__47020__$1;
var eval_fn = cljs.core.get.call(null,map__47020__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__47022_SHARP_);
});})(new_def))
);
...
return (function (p__47023){
var vec__47024 = p__47023;
var ky = cljs.core.nth.call(null,vec__47024,(0),null);
var v = cljs.core.nth.call(null,vec__47024,(1),null);
...
if(cljs.core.truth_((function (){var and__27040__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1501568771576