...
return (new CustomEvent(event_name,(function (){var obj40089 = {"detail":data};
return obj40089;
})()));
} else {
...
var f = (function (){var pred__40096 = cljs.core._EQ_;
var expr__40097 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__40096.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__40097))){
return ((function (pred__40096,expr__40097){
return (function (p1__40090_SHARP_){
return console.warn(p1__40090_SHARP_);
});
;})(pred__40096,expr__40097))
} else {
if(cljs.core.truth_(pred__40096.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__40097))){
return ((function (pred__40096,expr__40097){
return (function (p1__40091_SHARP_){
return console.debug(p1__40091_SHARP_);
});
;})(pred__40096,expr__40097))
} else {
if(cljs.core.truth_(pred__40096.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__40097))){
return ((function (pred__40096,expr__40097){
return (function (p1__40092_SHARP_){
return console.error(p1__40092_SHARP_);
});
;})(pred__40096,expr__40097))
} else {
return ((function (pred__40096,expr__40097){
return (function (p1__40093_SHARP_){
return console.log(p1__40093_SHARP_);
});
;})(pred__40096,expr__40097))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__40100){
var map__40101 = p__40100;
var map__40101__$1 = ((((!((map__40101 == null)))?((((map__40101.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40101.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40101):map__40101);
var opts = map__40101__$1;
var eval_fn = cljs.core.get.call(null,map__40101__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__40103_SHARP_);
});})(new_def))
);
...
return (function (p__40104){
var vec__40105 = p__40104;
var ky = cljs.core.nth.call(null,vec__40105,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1503550037226