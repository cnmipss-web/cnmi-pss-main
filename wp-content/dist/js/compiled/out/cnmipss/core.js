...
var len__37887__auto___44619 = arguments.length;
var i__37888__auto___44620 = (0);
while(true){
if((i__37888__auto___44620 < len__37887__auto___44619)){
args__37894__auto__.push((arguments[i__37888__auto___44620]));

var G__44621 = (i__37888__auto___44620 + (1));
i__37888__auto___44620 = G__44621;
continue;
} else {
}
break;
...
return cljs.core.mapv.call(null,(function (p1__44617_SHARP_){
return console.log(p1__44617_SHARP_);
}),args);
});

cnmipss.core.log.cljs$lang$maxFixedArity = (0);

cnmipss.core.log.cljs$lang$applyTo = (function (seq44618){
return cnmipss.core.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq44618));
});
...
var map__44622 = clojure.walk.keywordize_keys.call(null,cljs.core.js__GT_clj.call(null,data));
var map__44622__$1 = ((((!((map__44622 == null)))?((((map__44622.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44622.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44622):map__44622);
var violations = cljs.core.get.call(null,map__44622__$1,new cljs.core.Keyword(null,"violations","violations",835165468));
var passes = cljs.core.get.call(null,map__44622__$1,new cljs.core.Keyword(null,"passes","passes",-2141861841));
var incomplete = cljs.core.get.call(null,map__44622__$1,new cljs.core.Keyword(null,"incomplete","incomplete",-998567478));
var inapplicable = cljs.core.get.call(null,map__44622__$1,new cljs.core.Keyword(null,"inapplicable","inapplicable",-1070062408));
...
var G__44624 = cnmipss.core.path.call(null);
switch (G__44624) {
case "/cnmi-certification-look-up-database/":
return cnmipss.core.jq.get("/webtools/api/all-certs",((function (G__44624){
...
return cnmipss.core.jq.get("/webtools/api/all-jvas",((function (G__44624){
return (function (data){
re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-table","load-table",-1085622204),data], null));
...
return cnmipss.core.jq.get("/webtools/api/all-procurement",((function (G__44624){
return (function (data){
re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-table","load-table",-1085622204),data], null));
...
//# sourceMappingURL=core.js.map?rel=1502404148325