...
var len__37889__auto___50944 = arguments.length;
var i__37890__auto___50945 = (0);
while(true){
if((i__37890__auto___50945 < len__37889__auto___50944)){
args__37896__auto__.push((arguments[i__37890__auto___50945]));

var G__50946 = (i__37890__auto___50945 + (1));
i__37890__auto___50945 = G__50946;
continue;
} else {
}
break;
...
return cnmipss.core.log.cljs$core$IFn$_invoke$arity$variadic(argseq__37897__auto__);
});

cnmipss.core.log.cljs$core$IFn$_invoke$arity$variadic = (function (args){
return cljs.core.mapv.call(null,(function (p1__50942_SHARP_){
return console.log(p1__50942_SHARP_);
}),args);
});

cnmipss.core.log.cljs$lang$maxFixedArity = (0);

cnmipss.core.log.cljs$lang$applyTo = (function (seq50943){
return cnmipss.core.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50943));
});
...
var map__50947 = clojure.walk.keywordize_keys.call(null,cljs.core.js__GT_clj.call(null,data));
...
var violations = cljs.core.get.call(null,map__50947__$1,new cljs.core.Keyword(null,"violations","violations",835165468));
var passes = cljs.core.get.call(null,map__50947__$1,new cljs.core.Keyword(null,"passes","passes",-2141861841));
var incomplete = cljs.core.get.call(null,map__50947__$1,new cljs.core.Keyword(null,"incomplete","incomplete",-998567478));
var inapplicable = cljs.core.get.call(null,map__50947__$1,new cljs.core.Keyword(null,"inapplicable","inapplicable",-1070062408));
...
var G__50949 = cnmipss.core.path.call(null);
switch (G__50949) {
case "/cnmi-certification-look-up-database/":
return cnmipss.core.jq.get("/webtools/api/all-certs",((function (G__50949){
...
return cnmipss.core.jq.get("/webtools/api/all-jvas",((function (G__50949){
return (function (data){
re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-table","load-table",-1085622204),data], null));
...
return cnmipss.core.jq.get("/webtools/api/all-procurement",((function (G__50949){
return (function (data){
re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"load-table","load-table",-1085622204),data], null));
...
//# sourceMappingURL=core.js.map?rel=1502260569784