...
}catch (e41887){var e__38742__auto__ = e41887;
return e__38742__auto__;
}})()], null)], null),"Rendering interactive-view",active_view);

var G__41888 = active_view;
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cnmi-certification-look-up-database","cnmi-certification-look-up-database",-1487727293),G__41888)){
...
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"job-vacancy-announcements","job-vacancy-announcements",-1555714791),G__41888)){
...
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"contractors-and-vendors","contractors-and-vendors",1541875611),G__41888)){
...
if(cljs.core._EQ_.call(null,null,G__41888)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#floatingCirclesG","div#floatingCirclesG",-2116600059),(function (){var iter__37546__auto__ = ((function (G__41888,active_view,data){
return (function cnmipss$views$interactive_view_$_iter__41889(s__41890){
return (new cljs.core.LazySeq(null,((function (G__41888,active_view,data){
return (function (){
var s__41890__$1 = s__41890;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__41890__$1);
if(temp__4657__auto__){
var s__41890__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__41890__$2)){
var c__37544__auto__ = cljs.core.chunk_first.call(null,s__41890__$2);
var size__37545__auto__ = cljs.core.count.call(null,c__37544__auto__);
var b__41892 = cljs.core.chunk_buffer.call(null,size__37545__auto__);
if((function (){var i__41891 = (0);
while(true){
if((i__41891 < size__37545__auto__)){
var i = cljs.core._nth.call(null,c__37544__auto__,i__41891);
cljs.core.chunk_append.call(null,b__41892,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.f_circleG","div.f_circleG",-526902688),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("frotateG_0"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("floating-circle-"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)));

var G__41893 = (i__41891 + (1));
i__41891 = G__41893;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41892),cnmipss$views$interactive_view_$_iter__41889.call(null,cljs.core.chunk_rest.call(null,s__41890__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41892),null);
}
} else {
var i = cljs.core.first.call(null,s__41890__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.f_circleG","div.f_circleG",-526902688),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("frotateG_0"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("floating-circle-"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)),cnmipss$views$interactive_view_$_iter__41889.call(null,cljs.core.rest.call(null,s__41890__$2)));
}
} else {
return null;
}
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41888)].join('')));
...
//# sourceMappingURL=views.js.map?rel=1502754984739