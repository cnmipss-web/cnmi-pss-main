...
cnmipss.components.buttons.get_addendums = (function cnmipss$components$buttons$get_addendums(p__44581){
var map__44582 = p__44581;
var map__44582__$1 = ((((!((map__44582 == null)))?((((map__44582.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44582.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44582):map__44582);
var pns = map__44582__$1;
var id = cljs.core.get.call(null,map__44582__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var addenda = cljs.core.filter.call(null,((function (map__44582,map__44582__$1,pns,id){
return (function (p1__44580_SHARP_){
return (cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"rfp_id","rfp_id",-2126089212).cljs$core$IFn$_invoke$arity$1(p1__44580_SHARP_))) || (cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"ifb_id","ifb_id",1028058615).cljs$core$IFn$_invoke$arity$1(p1__44580_SHARP_)));
});})(map__44582,map__44582__$1,pns,id))
...
//# sourceMappingURL=buttons.js.map?rel=1502404148209