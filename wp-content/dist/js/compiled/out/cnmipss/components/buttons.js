...
cnmipss.components.buttons.get_addendums = (function cnmipss$components$buttons$get_addendums(p__54709){
var map__54710 = p__54709;
var map__54710__$1 = ((((!((map__54710 == null)))?((((map__54710.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54710.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54710):map__54710);
var pns = map__54710__$1;
var id = cljs.core.get.call(null,map__54710__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var addenda = cljs.core.filter.call(null,((function (map__54710,map__54710__$1,pns,id){
return (function (p1__54708_SHARP_){
return (cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"rfp_id","rfp_id",-2126089212).cljs$core$IFn$_invoke$arity$1(p1__54708_SHARP_))) || (cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"ifb_id","ifb_id",1028058615).cljs$core$IFn$_invoke$arity$1(p1__54708_SHARP_)));
});})(map__54710,map__54710__$1,pns,id))
,new cljs.core.Keyword(null,"addenda","addenda",1190896711).cljs$core$IFn$_invoke$arity$1(clojure.walk.keywordize_keys.call(null,cljs.core.js__GT_clj.call(null,cljs.core.deref.call(null,re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page-data","page-data",1443840710)], null)))))));
...
//# sourceMappingURL=buttons.js.map?rel=1503451500413