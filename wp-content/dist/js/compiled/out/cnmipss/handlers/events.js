...
var map__54566 = cljs.core.deref.call(null,re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pns-subs-errors","pns-subs-errors",-1721584085)], null)));
var map__54566__$1 = ((((!((map__54566 == null)))?((((map__54566.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54566.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54566):map__54566);
var company = cljs.core.get.call(null,map__54566__$1,new cljs.core.Keyword(null,"company","company",-340475075));
var person = cljs.core.get.call(null,map__54566__$1,new cljs.core.Keyword(null,"person","person",-1059806875));
var email = cljs.core.get.call(null,map__54566__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var tel = cljs.core.get.call(null,map__54566__$1,new cljs.core.Keyword(null,"tel","tel",224138159));
if(!((company == null))){
...
cnmipss.handlers.events.validate_subscription = (function cnmipss$handlers$events$validate_subscription(){
var jq = jQuery;
...
return ajax.core.ajax_request.call(null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"uri","uri",-774711847),"/webtools/api/subscribe-procurement",new cljs.core.Keyword(null,"method","method",55703592),new cljs.core.Keyword(null,"post","post",269697687),new cljs.core.Keyword(null,"params","params",710516235),cnmipss.util.edn__GT_json.call(null,cljs.core.assoc.call(null,cljs.core.assoc.call(null,values,new cljs.core.Keyword(null,"rfp_id","rfp_id",-2126089212),(cljs.core.truth_(new cljs.core.Keyword(null,"rfp_no","rfp_no",-1735597295).cljs$core$IFn$_invoke$arity$1(pns))?new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(pns):null)),new cljs.core.Keyword(null,"ifb_id","ifb_id",1028058615),(cljs.core.truth_(new cljs.core.Keyword(null,"ifb_no","ifb_no",282350117).cljs$core$IFn$_invoke$arity$1(pns))?new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(pns):null))),new cljs.core.Keyword(null,"format","format",-1306924766),ajax.core.json_request_format.call(null),new cljs.core.Keyword(null,"response-format","response-format",1664465322),cnmipss.util.full_response_format.call(null,ajax.core.json_response_format),new cljs.core.Keyword(null,"handler","handler",-195596612),cnmipss.handlers.api.subscribed.call(null,pns)], null));
}
});
});
...
//# sourceMappingURL=events.js.map?rel=1503451319812