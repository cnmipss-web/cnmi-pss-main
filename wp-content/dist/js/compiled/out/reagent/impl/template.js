...
var G__60891 = o;
(G__60891[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__60893__i < G__60893__a.length) {G__60893__a[G__60893__i] = arguments[G__60893__i + 0]; ++G__60893__i;}
  args = new cljs.core.IndexedSeq(G__60893__a,0);
} 
...
var G__60899 = jsprops;
(G__60899["defaultValue"] = value);

(G__60899["onChange"] = ((function (G__60899,v,value,on_change){
return (function (p1__60897_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__60897_SHARP_);
});})(G__60899,v,value,on_change))
);
...
var vec__60906 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__60906,(0),null);
var id = cljs.core.nth.call(null,vec__60906,(1),null);
var class$ = cljs.core.nth.call(null,vec__60906,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___60911 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___60911 == null)){
} else {
var key_60912 = temp__4661__auto___60911;
(jsprops["key"] = key_60912);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__60914 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__60914["name"] = c);
...
var len__27054__auto___60920 = arguments.length;
var i__27055__auto___60921 = (0);
while(true){
if((i__27055__auto___60921 < len__27054__auto___60920)){
args__27061__auto__.push((arguments[i__27055__auto___60921]));

var G__60922 = (i__27055__auto___60921 + (1));
i__27055__auto___60921 = G__60922;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq60918){
var G__60919 = cljs.core.first.call(null,seq60918);
var seq60918__$1 = cljs.core.next.call(null,seq60918);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__60919,seq60918__$1);
});
...
break;
default:
var G__60926 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__60926;
continue;
...
var n__26894__auto___60929 = a.length;
var i_60930 = (0);
while(true){
if((i_60930 < n__26894__auto___60929)){
(a[i_60930] = reagent.impl.template.as_element.call(null,(a[i_60930])));

var G__60931 = (i_60930 + (1));
i_60930 = G__60931;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26894__auto___60932 = a.length;
var i_60933 = (0);
while(true){
if((i_60933 < n__26894__auto___60932)){
var val_60934 = (a[i_60933]);
if((cljs.core.vector_QMARK_.call(null,val_60934)) && ((reagent.impl.template.key_from_vec.call(null,val_60934) == null))){
(o["no-key"] = true);
} else {
}

(a[i_60933] = reagent.impl.template.as_element.call(null,val_60934));

var G__60935 = (i_60933 + (1));
i_60933 = G__60935;
continue;
} else {
}
...
var ctx = ({});
var vec__60939 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__60939,(0),null);
var derefed = cljs.core.nth.call(null,vec__60939,(1),null);
...
var G__60943 = (cljs.core.count.call(null,argv) - first_child);
switch (G__60943) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__60943){
...
//# sourceMappingURL=template.js.map?rel=1498707047479