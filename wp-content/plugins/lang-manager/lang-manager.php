<?php
   /*
   Plugin Name: Lang Manager
   Plugin URI: 
   description: A plugin to manage the lang attribute in multi-lingual content
   Version: 0.0.1
   Author: Tyler Collins
   Author URI: http://tjscollins.me
   License: MIT
   */
?>
...
if(!class_exists('Html_Lang'))
{
  class Html_Lang
  {
    ...
    public function add_my_meta_boxes() {
      add_meta_box('htmllang-meta-box', __( 'Specify lang attribute', 'htmllang' ), array($this, 'show_my_meta_box'), 'post', 'normal', 'high');
    }
...
$HtmlLanguageAttribute = new HtmlLanguageAttribute();
?>
