...
<div id="featured-posts" class="flexslider widget-red">
	
	<ul class="slides wpzoom-featured-posts">
		<?php while ( $loop->have_posts() ) : $loop->the_post(); $m++; ?>
		<li class="wpzoom-featured-post">
			
			<?php get_the_image( array( 'size' => 'homepage-slider', 'width' => 560, 'height' => 300, 'default_image' => $default_image, 'before' => '<div class="post-cover">', 'after' => '</div>' ) ); ?>
