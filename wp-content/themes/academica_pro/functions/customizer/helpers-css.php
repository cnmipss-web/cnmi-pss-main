...
if ( ! class_exists( 'academica_pro_CSS' ) ) :
    /**
     ...
     */
    class academica_pro_CSS {

        /**
         * The one instance of academica_pro_CSS.
         *
         * @var   academica_pro_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one academica_pro_CSS instance.
         *
         * @return academica_pro_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'academica_pro_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `academica_pro_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'academica_pro_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'academica_pro_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'academica_pro_get_css' ) ) :
    /**
     * Return the one academica_pro_CSS object.
     *
     * @return academica_pro_CSS    The one academica_pro_CSS object.
     */
    function academica_pro_get_css() {
        return academica_pro_CSS::instance();
    }
endif;

add_action( 'init', 'academica_pro_get_css', 1 );