...
function academica_pro_customizer_define_general_sections( $sections ) {
...
add_filter( 'zoom_customizer_sections', 'academica_pro_customizer_define_general_sections' );
