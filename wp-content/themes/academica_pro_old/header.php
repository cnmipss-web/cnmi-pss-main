...
<head>
    ...
    <script>
        jQuery(document).ready(function() { 
          jQuery(".menu-item-10619 a, .menu-item-10623 a, .menu-item-11499 a, .menu-item-11508 a").click(function() {
              jQuery(this).next().slideToggle();
          })
	  var action = 1;
	  jQuery(".menu-header-nav-container ul li ul li a").click(function(e){
		if(action == 1){
			action = 2;
			e.preventDefault();
		}
