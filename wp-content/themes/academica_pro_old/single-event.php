<?php get_header(); ?>
	...
	<div id="main">
		...
		<div class="wrapper">
			...
			// FOR 12 HOUR FORMAT, CHANGE THE DATE FORMAT IN THE 2 LINES ABOVE
			// "H:i" displays the time in this format: 15:45
			// "h:i a" displays the time in this format: 03:45 pm
			// "h:i A" displays the time in this format: 03:45 PM
			// "g:i a" displays the time in this format: 3:45 pm
			?>
